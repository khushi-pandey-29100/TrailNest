-- TrailNest database
-- Run this whole file in phpMyAdmin (Import tab or SQL tab)

CREATE DATABASE IF NOT EXISTS trailnest_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE trailnest_db;
...
CREATE TABLE bookings (
  id INT AUTO_INCREMENT PRIMARY KEY,
  trek_id INT NULL,                   -- NULL = general enquiry from Contact page
  name VARCHAR(100) NOT NULL,
